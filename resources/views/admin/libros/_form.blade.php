...
<div class="mt-6 flex justify-end gap-3">
    <a href="{{ route('admin.libros.index') }}" class="px-5 py-2.5 rounded-lg text-sm font-semibold text-gray-600 hover:bg-gray-100 transition-colors">
        Cancelar
    </a>
    <button type="submit" class="bg-[#B8500C] hover:bg-[#963F07] transition-colors text-white px-6 py-2.5 rounded-lg text-sm font-semibold shadow-md">
        Guardar libro
    </button>
</div>
