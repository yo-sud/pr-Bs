    ...
    <div class="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden">
        ...
        <form action="{{ route('admin.repartidores.update', $repartidor->id) }}" method="POST" class="p-6 space-y-5">
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" name="ciudad" id="ciudad" value="{{ old('ciudad', $repartidor->ciudad) }}"
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" name="tiempo_entrega_estimado" id="tiempo_entrega_estimado" value="{{ old('tiempo_entrega_estimado', $repartidor->tiempo_entrega_estimado) }}"
