...
<div class="space-y-6 px-6 max-w-6xl mx-auto">
    ...
    <form action="{{ route('admin.reposicion.procesarpaso3') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <label class="relative bg-white rounded-2xl block cursor-pointer overflow-hidden shadow-sm hover:shadow-lg transition-all hover:-translate-y-1 select-none border-2 border-transparent has-[:checked]:border-blue-500">
            ...
            <label class="relative bg-white rounded-2xl block cursor-pointer overflow-hidden shadow-sm hover:shadow-lg transition-all hover:-translate-y-1 select-none border-2 border-transparent has-[:checked]:border-emerald-500">
