        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-10 border border-amber-100">
                ...
                <div class="text-center mb-8">
                    <h1 class="font-serif text-3xl font-bold text-amber-900 mb-2">Iniciar Sesión</h1>
                    <p class="text-stone-500">Accede a tu cuenta para continuar</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="tu@email.com" class="w-full pl-12 pr-4 py-3 border border-amber-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent transition-all bg-amber-50/50">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" required autocomplete="current-password" placeholder="••••••••" class="w-full pl-12 pr-4 py-3 border border-amber-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent transition-all bg-amber-50/50">
                        </div>
                        <x-input-error :messages="$errors->get('password')" class="mt-2 text-xs text-red-600" />
                    </div>

                    <button type="submit" class="w-full bg-amber-700 hover:bg-amber-800 text-white py-3 rounded-lg transition-all hover:shadow-lg flex items-center justify-center gap-2">
                ...
                <div class="text-center">
                    <p class="text-stone-600">¿No tienes una cuenta? 
                        <a class="text-amber-700 hover:text-amber-800 font-medium transition-colors" href="{{ route('register') }}">Regístrate aquí</a>
                    </p>
                </div>
