...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor introducido en :attribute ha aparecido en una filtración de datos. Por favor elija un :attribute diferente.',
    ],
    ...
    | hace rápido especificar una línea de idioma personalizada específica para
    ...
    */
    ...
    | de posición de los atributos con algo más amigable para el usuario, como
    | "Dirección de correo electrónico" en lugar de "email". Esto simplemente
    | nos ayuda a hacer que nuestros mensajes sean más expresivos.
    |
    */
